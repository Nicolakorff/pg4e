...
doc = {
    'author': 'kimchy',
    'type' : 'tweet',
    'text': 'Elasticsearch: memory are disk drives or flash memory typically found in USB sticks and portable music players keyboard mouse microphone speaker touchpad etc They are all of the ways we interact with the computer Connection to retrieve information over a network We can',
